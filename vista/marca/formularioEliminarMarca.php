                        ...
                        <div class="row">
                            <div class="col">
                                <h3 class="text-center text-primary">
                                    <?php  echo $marca->getMarId() . " - " .$marca->getMarNombre() ?>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="eliminarMarca.php" method="POST">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <input name="mar_id" type="hidden" class="form-control" id="mar_id" value="<?php echo $marca->getMarId() ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <a class="btn btn-success" href="listarMarca.php">Regresar al listado</a>
                                </div>
                            </div>
                        </form>
                    </div>
